...
class RobotMoveActionGoal(genpy.Message):
  _md5sum = "cf2c326006189b348e6622a83680b593"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.goal.cmd.cmd_type, _x.goal.cmd.tcp_version))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.cmd.cmd_type, _x.goal.cmd.tcp_version,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
