...
class ArmMoveCommand(genpy.Message):
  _md5sum = "b6f4e88a8131ef02ebd87e4857647344"
...
"""
  ...
  __slots__ = ['cmd_type','tcp_version','joints','position','rpy','orientation','shift','list_poses','dist_smoothing','trajectory','args']
  _slot_types = ['int32','int32','float64[]','geometry_msgs/Point','niryo_robot_msgs/RPY','geometry_msgs/Quaternion','niryo_robot_arm_commander/ShiftPose','geometry_msgs/Pose[]','float32','trajectory_msgs/JointTrajectory','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       cmd_type,tcp_version,joints,position,rpy,orientation,shift,list_poses,dist_smoothing,trajectory,args
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.cmd_type, _x.tcp_version))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cmd_type, _x.tcp_version,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
