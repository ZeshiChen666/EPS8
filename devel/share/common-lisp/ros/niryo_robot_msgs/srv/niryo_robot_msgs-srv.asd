...
(defsystem "niryo_robot_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "GetFloatList" :depends-on ("_package_GetFloatList"))
    (:file "_package_GetFloatList" :depends-on ("_package"))
    ...
    (:file "SetFloatList" :depends-on ("_package_SetFloatList"))
    (:file "_package_SetFloatList" :depends-on ("_package"))
