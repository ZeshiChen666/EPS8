...
(defsystem "niryo_robot_msgs-msg"
  ...
  :components ((:file "_package")
    (:file "BasicObject" :depends-on ("_package_BasicObject"))
    (:file "_package_BasicObject" :depends-on ("_package"))
    (:file "BasicObjectArray" :depends-on ("_package_BasicObjectArray"))
    (:file "_package_BasicObjectArray" :depends-on ("_package"))
