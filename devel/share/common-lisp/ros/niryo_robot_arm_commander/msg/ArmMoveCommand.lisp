...
(cl:defmethod tcp_version-val ((m <ArmMoveCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_arm_commander-msg:tcp_version-val is deprecated.  Use niryo_robot_arm_commander-msg:tcp_version instead.")
  (tcp_version m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ArmMoveCommand>)))
  ...
  "b6f4e88a8131ef02ebd87e4857647344")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ArmMoveCommand)))
  "Returns md5sum for a message object of type 'ArmMoveCommand"
  "b6f4e88a8131ef02ebd87e4857647344")
