...
(cl:defmethod message-val ((m <RunAutoDiagnosis-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_reports-srv:message-val is deprecated.  Use niryo_robot_reports-srv:message instead.")
  (message m))
