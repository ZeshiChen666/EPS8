...
(cl:ensure-generic-function 'tcp_version-val :lambda-list '(m))
(cl:defmethod tcp_version-val ((m <SetTCP-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_tools_commander-srv:tcp_version-val is deprecated.  Use niryo_robot_tools_commander-srv:tcp_version instead.")
  (tcp_version m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<SetTCP-request>)))
    "Constants for message type '<SetTCP-request>"
  '((:LEGACY . 1)
    (:DH_CONVENTION . 2))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'SetTCP-request)))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SetTCP-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'tcp_version)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SetTCP-request>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'orientation) istream)
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'tcp_version) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetTCP-request>)))
  ...
  "d3a7890823ba564daceabf73bdc6760d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetTCP-request)))
  "Returns md5sum for a message object of type 'SetTCP-request"
  "d3a7890823ba564daceabf73bdc6760d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetTCP-request>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%~%#Only one of the two is required.~%#If both are filled, the quaternion will be chosen by default~%niryo_robot_msgs/RPY rpy~%geometry_msgs/Quaternion orientation~%~%int32 LEGACY = 1~%int32 DH_CONVENTION = 2~%int32 tcp_version~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: niryo_robot_msgs/RPY~%# roll, pitch and yaw~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetTCP-request)))
  "Returns full string definition for message of type 'SetTCP-request"
  (cl:format cl:nil "geometry_msgs/Point position~%~%#Only one of the two is required.~%#If both are filled, the quaternion will be chosen by default~%niryo_robot_msgs/RPY rpy~%geometry_msgs/Quaternion orientation~%~%int32 LEGACY = 1~%int32 DH_CONVENTION = 2~%int32 tcp_version~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: niryo_robot_msgs/RPY~%# roll, pitch and yaw~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SetTCP-request>))
  ...
  (cl:list 'SetTCP-request
    ...
    (cl:cons ':tcp_version (tcp_version msg))
))
