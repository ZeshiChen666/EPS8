...
class StorageStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('total_disk_size')) {
        this.total_disk_size = initObj.total_disk_size
      }
      else {
        this.total_disk_size = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [total_disk_size]
    bufferOffset = _serializer.int32(obj.total_disk_size, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StorageStatus(null);
    ...
    // Deserialize message field [total_disk_size]
    data.total_disk_size = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new StorageStatus(null);
    ...
    if (msg.total_disk_size !== undefined) {
      resolved.total_disk_size = msg.total_disk_size;
    }
    else {
      resolved.total_disk_size = 0
    }
