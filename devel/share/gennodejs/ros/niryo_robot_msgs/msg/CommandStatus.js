...
class CommandStatus {
  ...
  static md5sum() {
    ...
    return '7ff617ff1050a58e5034b966d140d071';
  }
...
CommandStatus.Constants = {
  ...
  FORWARD_KINEMATICS_FAILURE: -233,
  TOOL_FAILURE: -251,
  TOOL_ID_INVALID: -252,
  ...
  DYNAMIC_FRAME_DOES_NOT_EXISTS: -304,
  ...
  PROGRAMS_MANAGER_PROGRAM_ALREADY_RUNNING: -324,
