...
#endif
#if defined(_WIN32) && defined(HARDWARE_NOT_SUPPORTED)
  #undef HARDWARE_NOT_SUPPORTED
#endif
...
#endif
#if defined(_WIN32) && defined(FORWARD_KINEMATICS_FAILURE)
  #undef FORWARD_KINEMATICS_FAILURE
#endif
...
#endif
#if defined(_WIN32) && defined(DYNAMIC_FRAME_DOES_NOT_EXISTS)
  #undef DYNAMIC_FRAME_DOES_NOT_EXISTS
#endif
...
#endif
#if defined(_WIN32) && defined(PROGRAMS_MANAGER_PROGRAM_ALREADY_RUNNING)
  #undef PROGRAMS_MANAGER_PROGRAM_ALREADY_RUNNING
#endif
...
struct MD5Sum< ::niryo_robot_msgs::CommandStatus_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7ff617ff1050a58eULL;
  static const uint64_t static_value2 = 0x5034b966d140d071ULL;
};
