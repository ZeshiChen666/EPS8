...
struct ScanI2CBusResponse_
{
  ...
  _is_ok_type is_ok;
   ...
   typedef std::vector< ::niryo_robot_rpi::I2CComponent_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::niryo_robot_rpi::I2CComponent_<ContainerAllocator> >::other >  _missing_type;
  _missing_type missing;

   typedef std::vector< ::niryo_robot_rpi::I2CComponent_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::niryo_robot_rpi::I2CComponent_<ContainerAllocator> >::other >  _detected_type;
